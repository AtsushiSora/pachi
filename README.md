...
- トップ、ランキング、チャレンジ、ジャグ連、スペック、実戦の主要導線
...
公開後や審査待ち中の手動作業は `OPERATIONS.md` にまとめています。
...
再実行が必要な時の運用手順は `OPERATIONS.md` を参照してください。
...
ストア掲載文は `mobile-app/STORE_LISTING_DRAFT.md`、スクリーンショット計画は `mobile-app/SCREENSHOT_PLAN.md`、データ取扱い整理は `mobile-app/PRIVACY_DISCLOSURE.md` にあります。
